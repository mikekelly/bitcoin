...
{
    const char* pszTimestamp = "I didn't attend the funeral, but I sent a nice letter saying I approved of it.";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1613212249, 7248, 0x1f0fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0002ada75121f702a5bae88b0891f01e3cf218085284a294aa501bc2a9f429a2"));
        assert(genesis.hashMerkleRoot == uint256S("0xafb28ac8a701144fdf61dd02280b6739d2a10717dd45a09742cc960d3acfc3d6"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x0002ada75121f702a5bae88b0891f01e3cf218085284a294aa501bc2a9f429a2")},
            }
        };
